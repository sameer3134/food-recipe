...
function Recipecard({recipe}) {
  ...
  return (
      <div className='card shadow p-3 mb-5 bg-white rounded' onClick={()=>{window.open(recipe["recipe"]["url"])}}><img src={recipe["recipe"]["image"]} alt="designed by Mohd Sameer" className="card-img-top"/>
